...
func (this *VideoHandler) DeleteVideo(c echo.Context) error {
...
func (this *VideoHandler) GetVideo(c echo.Context) error {
	var video Video
...
func (this *VideoHandler) UpdateVideo(c echo.Context) error {
...
func modifyVideo(ctx context.Context, id string, reqBody io.ReadCloser, collection *mongo.Collection) (Video, error) {
	...
	if err := validator.New().Struct(video); err != nil {
